...
class Walletconnect extends _$Walletconnect {
    ...
    if (event != null) {
      ...
      if (jsonObject is JsonRpcRequest) {
        ...
        DeepLinkHandler.waiting.value =
            _loaderMethods.contains(jsonObject.method);
      }
    }
  }
  ...
  void onSessionProposal(SessionProposalEvent? args) async {
    ...
    if (args != null) {
      ...
      final result = (await bottomSheetHandler.queueBottomSheet(
  ...
  void onSessionProposalError(SessionProposalErrorEvent? args) async {
    ...
    if (args != null) {
      ...
      MethodsUtils(walletKit: walletKit!).goBackModal(
        title: 'Error',
  ...
  void onSessionAuthRequest(SessionAuthRequest? args) async {
    ...
    if (args != null) {
      ...
      final WCBottomSheetResult rs = (await bottomSheetHandler.queueBottomSheet(
