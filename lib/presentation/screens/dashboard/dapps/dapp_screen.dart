...
class _DappScreenState extends ConsumerState<DappScreen> {
                  ...
                  onEditingComplete: () {
                    if (ref.watch(searchWebProvider).text.isNotEmpty) {
                      showModalBottomSheet(
                        context: context,
                        builder:
                            (context) => SheetSelectNetworkDapp(
              ...
              .when(
                ...
                loading: () {
                  return Row(
                    ...
                    children: List.generate(
                      6,
                      (index) => ShimmerLoading(width: 54, height: 54),
                    ),
                  );
                },
              ),
                      ...
                      tabs: List.generate(
                        ...
                        (index) => Container(
                          ...
                          margin: EdgeInsets.only(
                            left: listChain[index] == listChain.first ? 16 : 0,
                            right: listChain[index] == listChain.last ? 16 : 8,
                          ),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(6),
                            color:
                                ref.watch(indexbarDapp) == index
              ...
              (index) => Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(ref.watch(newsDappProvider)[index]),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
  ...
  Widget indicator(int index, WidgetRef ref) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            ref.watch(indexCarouselProvider) == index
                ? AppColor.primaryColor
                : AppColor.grayColor,
