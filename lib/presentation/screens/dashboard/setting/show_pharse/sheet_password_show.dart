...
final pinShowController = StateProvider<TextEditingController>(
  (ref) => TextEditingController(),
);

class SheetPasswordShow extends ConsumerWidget {
  const SheetPasswordShow({super.key});
            ...
            Numpadcustom(
              ...
              delete: () {
                ref.watch(pinShowController).text =
                    ref.watch(pinShowController).text != ''
                        ? ref
                            .watch(pinShowController)
                            .text
                            .substring(
                              0,
                              ref.watch(pinShowController).text.length - 1,
                            )
                        : ref.watch(pinShowController).text;
              },
            ),
